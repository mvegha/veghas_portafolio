...
const App: React.FC = () => {
  ...
  const [darkMode, setDarkMode] = useState<boolean>(() => {
    // Verifica si hay una preferencia guardada o usa la del sistema
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 text-gray-900 dark:text-gray-100 transition-colors duration-300 font-sans selection:bg-indigo-500 selection:text-white">
      {/* NAVBAR: Navegación y Toggle Dark Mode */}
      ...
      <footer className="bg-white dark:bg-gray-950 py-8 border-t border-gray-100 dark:border-gray-800 transition-colors">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <p className="text-gray-500 dark:text-gray-400 text-sm">
            © {new Date().getFullYear()} Desarrollado por <span className="text-black-500">Mariano Vega</span>
          </p>
        </div>
      </footer>
    </div>
